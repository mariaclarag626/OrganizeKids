        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          ...
          <div className='bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20'>
            <div className='text-center'>
              ...
              <button className='w-full py-2 px-4 bg-pink-600 hover:bg-pink-700 text-white rounded-lg transition-colors'>
                View Family
              </button>
            </div>
          </div>
          ...
          <div className='bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20'>
            <div className='text-center'>
              ...
              <button className='w-full py-2 px-4 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors'>
                View Settings
              </button>
            </div>
          </div>
