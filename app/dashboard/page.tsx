  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(135deg, rgba(27, 3, 55, 0.8) 0%, rgba(18, 3, 38, 0.9) 100%)',
        }}
      />
          ...
          >
            ...
            <div className='flex space-x-3'>
              ...
              <div className='flex-1 relative'>
                ...
                {showTimePicker && (
                  <div className='absolute top-full mt-2 right-0 w-full bg-purple-900/95 backdrop-blur-md rounded-2xl border border-white/20 p-4 shadow-xl z-10'>
                    <input
                      type="time"
                      value={newTask.time}
                      onChange={(e) => {
